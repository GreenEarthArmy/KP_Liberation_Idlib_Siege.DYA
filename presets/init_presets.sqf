switch (KP_liberation_preset_blufor) do {
    ...
    case 28: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\Turkish_Backed_Jihadists.sqf";};
    case 29: {[] call compileFinal preprocessFileLineNumbers "presets\blufor\SAA.sqf";};
...
squads = [
    [blufor_squad_inf_light,20,4,0],
    [blufor_squad_inf,35,5,0],
    [blufor_squad_at,26,10,0],
    [blufor_squad_aa,45,10,0],
    [blufor_squad_recon,33,4,0]
